...
a) categorical: License_type and Sub_type features that assume few distinct values only. I used DictVectorizer to transform the string features into 0/1 feature vectors. 
